        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Employee Detachment</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?=$admins_acc->ec_name?></td>
                    <td><?=$admins_acc->ec_branch?></td>
                    <td><?=$admins_acc->position?></td>
                    <td><?=date('M j, Y h:i A',$admins_acc->ec_date_hired)?></td>
                    <!-- <td><?=$admins_acc->gender == 1 ? "Male" : "Female"?></td> -->
                    <td>
                      <a href="<?=base_url('admin/edit_detachment/').$admins_acc->user_id?>" class="btn btn-warning">EDIT</a>
