        ...
        <div class="box box-primary">
          <div class="box-body box-profile">
            ...
            <ul class="list-group list-group-unbordered">
              ...
              <!-- <li class="list-group-item">
              <a href="<?=base_url('admin/change_pass')?>" class="lsit-group-item pull-left">Change Password</a> <br>
              </li> -->
      ...
      <div class="col-md-9">
        <div class="nav-tabs-custom box-header with-border">
          <ul class="nav nav-tabs">
            ...
            <a href="<?=base_url('admin/admin_profile')?>" class="btn btn-success">Back</a>
          </ul>
              ...
              <div class="container-fluid">
                ...
                <div class="row">
                  <div class="col-md-12" style="float: none;margin: 0 auto;">
                    <form action="<?=base_url('admin/change_profile_picture')?>" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        <label for="exampleInputFile">Change profile picture:</label>
                        <input type="file" id="exampleInputFile" name="profile_picture">
