        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
                          ...
                          <form>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="radio">
                                  <label>
                                    <input type="radio" name="sms_content_val" value="<?=$sms->w_sms_content_passed?>" checked>
                                    Passed
                                  </label>
                                </div>
                                <div class="radio">
                                  <label>
                                    <input type="radio" name="sms_content_val" value="<?=$sms->w_sms_content_failed?>">
                                    Failed
                                  </label>
                                </div>
                              </div>
              ...
              <div class="modal modal-success fade" id="sent_success_modal" style="display: none;">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
