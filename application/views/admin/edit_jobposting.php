...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?=base_url('admin/jobs')?>">Edit Job Posting</a></li>
            ...
            <div class="container-fluid">
              <div class="row">
                <div class="col-md-6" style="float: none;margin: 0 auto;">
                  <form action="<?=base_url('admin/edit_job/').$spec_job->job_id?>" method="post">
                    <div class="form-group has-feedback  <?php if(!empty(form_error('job_name'))): ?> has-error <?php endif?>">
                      <input type="text" name="job_name" class="form-control" placeholder="Job name" value="<?=$spec_job->job_name?>">
                    ...
                    <div class="form-group has-feedback <?php if(!empty(form_error('job_req'))): ?> has-error <?php endif?>">
                      <textarea name="job_req" class="form-control disable-resize" placeholder="Job requirements"><?=$spec_job->job_requirements?></textarea>
                    ...
                    <div class="form-group has-feedback  <?php if(!empty(form_error('job_vacant'))): ?> has-error <?php endif?>">
                      <input type="text" name="job_vacant" class="form-control" placeholder="Job vacancy" value="<?=$spec_job->job_vacancy?>">
