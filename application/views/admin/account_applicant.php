        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Applicants Records</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<#>" class="btn btn-warning">View Form</a>
                      <button type="button" class="btn <?=$admins_acc->status == 0 ? 'btn-danger' : 'btn-defult' ?>" data-toggle="modal" data-target="#modal-default<?=$admins_acc->user_id?>"><!-- <?=$admins_acc->status == 0 ? 'Activate' : 'Deactivate' ?> -->HIRE</button>
                      <div class="modal fade" id="modal-default<?=$admins_acc->user_id?>">
                        <!-- <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            Form Register
                            <form action="<?=base_url('admin/delete_applicant/').$admins_acc->user_id.'/'.$admins_acc->status?>" method="post">
