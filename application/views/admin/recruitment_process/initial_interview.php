                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td><?=$applicant['exam_score']."/".$total_points?></td>
                                
                                <td>
                                    <a class="btn btn-block btn-sm btn-primary btn-flat" href="<?=base_url('admin/proceedToFinal/'.$applicant['id']."/".$applicant['contact_number'])?>">Proceed to Final</a>
