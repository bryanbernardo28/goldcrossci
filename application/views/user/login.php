...
<div class="login-box">
  ...
  <div class="login-box-body" style="background-color: rgb(255,255,255,0.4);">
    ...
    <form action="<?=base_url('clientlogin/login')?>" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control"name="clientpass" placeholder="Password" text-align:=left>
    ...
    <a href="<?=base_url('clientlogin/register')?>" class="text-center">Register account</a>
