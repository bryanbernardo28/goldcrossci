              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?=base_url('user/edit_client/').$admins_acc->user_id?>" class="btn btn-warning">EDIT</a>
                      ...
                      <div class="modal fade" id="modal-default<?=$admins_acc->user_id?>">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <!-- Form Register -->
                            <form action="<?=base_url('user/delete_client/').$admins_acc->user_id.'/'.$admins_acc->status?>"
                             method="post">
