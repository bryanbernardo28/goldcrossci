...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="<?=base_url('clientlogin/forgotPassword')?>" method="post">
...
<div class="limiter">
  ...
  <div class="wrap-login100 p-t-30 p-b-50">
    ...
    <form action="<?=base_url('clientlogin/forgotPassword')?>" method="post" class="login100-form validate-form p-b-33 p-t-5">
      <div class="form-group  has-feedback <?php if(!empty(form_error('femail'))): ?> has-error <?php endif?>">
        <input type="email" class="form-control" name="femail" placeholder="Email">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
        <?=form_error('femail','<span class="help-block">','</span>')?>
