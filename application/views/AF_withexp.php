...
<p>Military/Police Service Record: 
<?php
...
<p>OFFICE MACHINE/EQUIPMENT/VEHICLE OPERATED: <?=$ae_info["machine_operated[]"]?></p>
...
<p>Name Of Company: <?=$aer_info["name_of_company"]?></p>
<p>Position: <?=$aer_info["position"]?></p>
<p>Experience: <?=$aer_info["period_from"]?> to <?=$aer_info["period_to"]?> </p>
</body>
</html>